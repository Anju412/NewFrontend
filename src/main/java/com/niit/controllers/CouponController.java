...
public class CouponController {
	...
	public String insertCategory(Model m ,@RequestParam("couponName")String couponName,@RequestParam("couponValue")int couponValue){
		flag=false;
	...
	public String updateCoupon(@RequestParam("couponName")String couponName,@RequestParam("couponValue")int couponValue, Model m){
		flag=false;
		Coupon coupon=couponDAO.getCoupon(couponName);		
		coupon.setCouponName(couponName);
		coupon.setCouponValue(couponValue);
