...
public class OrderController {
	...
	public String checkOutProcess(Model m, HttpSession session, HttpServletRequest request)
	{
	...
	public String paymentProcess(Model m,HttpSession session, HttpServletRequest request)
	{
       // String username=(String)session.getAttribute("username");
		String username=(String)request.getUserPrincipal().getName();
